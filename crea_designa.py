...
def generar_skills_resolc(datos, identificativos, partida, fecha, centre_educatiu, carrec, numero_a_letras=lambda x:str(x)):
    ...
    if juridico == "funcionario gva":
        ...
        designa_text = (
            f"Vist l'informe de la subdirectora general del {fecha}, corresponent a la formació {codigo} - {curso} "
        ...
        if "semipresencial" in modalidad_lower:
            ...
            modalidad_text = f"presencial"
        designa_text = (
            f"Vist l'informe del director del CEFIRE de Formació Professional i Ensenyances artístiques i esportives {fecha}, corresponent a la formació {codigo} - {curso} "
            f"realitzada de manera{modalidad_text} del {fechas}.\n"
