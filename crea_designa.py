...
def generar_skills(datos, identificativos, partida, numero_a_letras=lambda x:str(x)):
    ...
    p.add_run("\nArmando Martí Recuenco, Director General de Formació Professional, de la Conselleria d’Educació, Cultura i Universitats\n").bold = True
    ...
    p_firma.add_run("Armando Martí Recuenco\nDirector General de Formació Professional, de la Conselleria d’Educació, Cultura i Universitats").bold = True
...
def generar_skills_certifica(datos, identificativos, numero_a_letras=lambda x:str(x)):
    ...
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    p.add_run("\n\nCarolina Part Julio, Subdiretora General de Innovació, Orientació i Acreditació Profesional, de la Direcció General de Formació Professional.\n").bold = True
    ...
    p_firma = doc.add_paragraph()
    p_firma.alignment = WD_ALIGN_PARAGRAPH.CENTER
    p_firma.add_run("Carolina Part Julio, Subdiretora General de Innovació, Orientació i Acreditació Profesional, de la Direcció General de Formació Professional")
